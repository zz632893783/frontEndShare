...
const commands = [
	...
	{ dir: 'C:/Users/10138/Desktop/前端分享/nodejs/robotjs', command: 'ffmpeg -f gdigrab -framerate 15 -video_size 1920x1080 -i desktop -c:v libx264 -preset ultrafast -tune zerolatency -crf 18 -b:v 80k -g 15 -f flv rtmp://10.10.4.53:1935/live/desktopLive' },
